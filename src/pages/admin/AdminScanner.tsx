...
export default function AdminScanner() {
    ...
    return (
        <div className="space-y-6 max-w-lg mx-auto">
            <div>
                <h1 className="text-2xl font-bold tracking-tight">สแกนเข้างาน</h1>
                <p className="text-muted-foreground">เลือกกิจกรรมและสแกน QR Code จากผู้เข้าร่วม</p>
            </div>
                ...
                <CardContent>
                    {eventsLoading ? (
                        ...
                        <Alert variant="destructive">
                            ...
                            <AlertDescription>
                                ไม่มีกิจกรรมที่เปิดใช้งานในขณะนี้ รบกวนตรวจสอบในระบบหลังบ้านเปิดใช้งานกิจกรรมแล้วหรือยัง
                            </AlertDescription>
                        </Alert>
                    ) : (
                        <Select
